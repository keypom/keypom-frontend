...
import { ViewFinder } from '@/common/components/ViewFinder';
import nearConfig from '@/common/utils/near';
...
const Scanner = () => {
  ...
  const claim = async (secretKey) => {
    ...
    const userAccount = await getClaimAccount(keyPair.toString());
    const password = get(router.query.password.toString());
