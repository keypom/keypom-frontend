...
export const EVENTS_WORKER_IPFS_PINNING =
  process.env.REACT_APP_NETWORK_ID === 'mainnet'
    ...
    : 'https://stripe-worker-template.keypom.workers.dev/ipfs-pin';
...
export const KEYPOM_EVENTS_CONTRACT =
  process.env.REACT_APP_NETWORK_ID === 'mainnet'
    ? 'ticketing-v1.keypom.near'
    : '1717013187496-kp-ticketing.testnet';
export const KEYPOM_MARKETPLACE_CONTRACT =
  process.env.REACT_APP_NETWORK_ID === 'mainnet'
    ? 'marketplace-v1.keypom.near'
    : '1717013187496-marketplace.testnet';
